<div class="related-sports cat">

	<div class="related-title cat">
		<h4><?php _e('Upcoming Sports', 'stream-sports') ?></h4>
	</div>

	<?php

	$sports_cat_meta = get_post_meta(get_the_ID(), 'sport_cat_meta_options', true);
	...
	$args = array(
		...
		'tax_query' => array(
			...
			array(
				...
				'field'    => 'term_id',
				'terms'    => array( $sports_cat_meta['sport_category'] ),
			),
		),
	);
	// the query
